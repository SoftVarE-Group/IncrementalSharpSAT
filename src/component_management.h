...
public:
  ...
  // called before every solving run
  void prepare(LiteralIndexedVector<Literal> & literals,
  ...
  void translateCache(vector<unsigned int>& translation_table){
    cache_.translate(translation_table);;
  }

  void removeCacheEntriesDamagedByChanges(vector<LiteralID> &lit_pool,
                                          vector<ClauseOfs> &added_long_clauses_,
                                          vector<BinaryClause> &added_binary_clauses_,
                                          vector<LiteralID> &added_unit_clauses_,
                                          vector<LiteralID> &assumptions_,
